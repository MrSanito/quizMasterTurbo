const images = [
	...
	},
	{
		...
		psdPath:
			"/images/—Pngtree—win clipart cartoon smiling boy_12151547 (1).psd",
	},
	{
		name: "Smiling Boy Cartoon (2)",
		path: "/images/—Pngtree—win clipart cartoon smiling boy_12151547 (2).png",
		psdPath:
			"/images/—Pngtree—win clipart cartoon smiling boy_12151547 (2).psd",
	},
];
		...
		<div className="min-h-screen bg-slate-950 text-slate-100 p-8 flex flex-col items-center">
			<div className="max-w-6xl w-full text-center mb-12">
				...
				<p className="text-slate-400 text-lg">
					Viewing successfully processed PSD files converted into
					browser-renderable PNG assets.
				</p>
			</div>
