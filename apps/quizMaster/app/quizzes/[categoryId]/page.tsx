...
import { ArrowRight, ArrowLeft, Trophy, Sparkles, HelpCircle, Play } from "lucide-react";
      ...
      <div className="relative z-10 w-full max-w-5xl flex flex-col items-center">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="text-slate-200 text-sm md:text-base leading-relaxed">
            Pick a quiz below to start answering questions, earn points, and climb the leaderboard!
          </p>
        </div>
        ...
        {quizzes.length === 0 ? (
          <div className="w-full max-w-md rounded-3xl bg-white/10 backdrop-blur-xl border border-white/20 p-8 text-center shadow-xl">
            ...
            <h3 className="text-lg font-bold text-white mb-1">No Quizzes Available</h3>
            <p className="text-sm text-slate-300 mb-6">There are no active quizzes for this category yet.</p>
            <button
              onClick={() => router.push("/categories")}
