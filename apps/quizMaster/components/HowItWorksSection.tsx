			...
			<div className="container mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
				...
				>
					...
					<p className="text-lg text-slate-350 mb-8 leading-relaxed">
						Every correct answer brings you closer to glory. Compete against the
						best minds worldwide and etch your name in the global leaderboard.
				...
				>
					{/* Decorative Elements */}
					<Trophy
						className="absolute -top-8 -right-8 text-yellow-400 opacity-20 rotate-12"
						size={120}
					/>
					...
					<div className="bg-[#1b0654] rounded-3xl shadow-2xl border border-[#5B32B4]/30 overflow-hidden text-white">
						<div className="p-6 border-b border-[#5B32B4]/30 flex justify-between items-center bg-[#150442]/50 backdrop-blur-md">
							...
							<button className="btn btn-xs btn-ghost text-indigo-400 hover:bg-white/5">
								View All
							</button>
						</div>
						<div className="p-2">
							{topPlayers.map((player, index) => (
								<div
									key={index}
									className="flex items-center justify-between p-3 hover:bg-[#340C97]/30 rounded-xl transition-colors cursor-pointer group"
								>
									<div className="flex items-center gap-4">
										<div
											className={`w-8 h-8 flex items-center justify-center font-bold text-sm rounded-full ${
												index === 0
