...
import { BrainCircuit, Flame, Trophy, Users, Zap } from "lucide-react";

const features = [
	{
		title: "Real-Time Multiplayer",
		description:
			"Challenge friends or match with random players globally in intense live battles.",
		icon: Users,
			...
			<div className="container mx-auto px-6 md:px-12">
				<div className="text-center max-w-2xl mx-auto mb-16">
					...
					<p className="text-slate-400 text-lg">
						Packed with features to keep you engaged, learning, and competing at
						the highest level.
					</p>
				</div>
