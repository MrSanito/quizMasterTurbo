...
export const getQuiz = catchAsync(async (c: any) => {
...
export const submitQuiz = catchAsync(async (c: any) => {
	const quizId = c.req.param("quizId");
...
export const getQuizResultByAttemptId = catchAsync(async (c: any) => {
...
export const getQuizHistory = catchAsync(async (c: any) => {
